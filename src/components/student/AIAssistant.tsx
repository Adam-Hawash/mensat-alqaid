...
export function AIAssistant() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: 'أهلاً بيك 👋 أنا المساعد الذكي لمنصة مستر عمرو رشدي. اسألني أي حاجة في الدراسات والتاريخ، ولو عندك واجب: جرب تحل الأول وصوّر إجابتك وابعتلي الصورة — هوريك إجابتك زي ما كتبتها وأقارنها بالإجابة الصحيحة سؤال بسؤال 📸',
    },
  ])
